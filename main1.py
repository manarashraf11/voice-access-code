...
class MainApp(QtWidgets.QMainWindow, task5UImanar.Ui_MainWindow):
    def __init__(self):
       ...
       # Connect actions to methods
        ...
        image_path_5_ac_2 = r'F:\task005\icons\door (2).png'  # Replace with the actual image path
 ...
 # function that get the id of the word 
    ...
    def predict_speaker(self):
            ...
            x = self.extract_features(audio, sr)
           ...
           # check the id of the persons 
            ...
            self.plot_pie_chart(probabilities, ["Manar", "Salma", "Sara", "Yasmeen", "Others"])
            self.predict_word()
